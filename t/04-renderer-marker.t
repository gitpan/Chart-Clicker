...
BEGIN {
    use_ok('Chart::Clicker::Renderer::Marker');
...
my $rndr = new Chart::Clicker::Renderer::Marker();
ok(defined($rndr), 'new Marker Renderer');
isa_ok($rndr, 'Chart::Clicker::Renderer::Marker');
